...
def run(data, bot_info, send):
    help_message = "\n\n.flow -> Rowing info\n.exec -> Exec Board\n.compass -> Compass\n.8ball -> say 8ball followed by a message\nMade by: Chris Hardin\nHosted by: Tristan Oestreich"
    exec_message = "Exec Board Spring 2022\n------------------\nPresident: Josh Ryan\nVice President: Jude Butler\nMen's Captain: Tristan Oestreich\nWomen's Captain: Grace Steensma\nCoxswain Captain: Morgan Phelps\nTresurer: Sir Billiam Doerries\nSecretary: Zach Scott\nPR/Alumni Rep: Andy Denekas\nRecruitment Chair: Federico Moreno\n\n"
    zach_message = "."
